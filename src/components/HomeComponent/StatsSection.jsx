  ...
  return (
    ...
    <Row className='d-flex flex-column-reverse flex-md-row align-items-center my-5'>
        ...
        <Row>
            ...
            <p className='text-muted'>Satisfied clients with reliable financial solutions.</p>
            </Col>
            <Col md={6} sm={12}> 
            <h1 className="fw-bold display-5 mt-3">60+</h1>
            <p className='text-muted' >Branches nationwide, offering financial services across the country.</p>
            </Col>
        </Row>
        <div className='mt-4'>
