    ...
    <Container fluid className='custom-x-padding py-5'>
        <Row className='my-5 text-center justify-content-center'>
            <Col lg={8}>
                ...
                alt='Franchisee Logo' 
                className='' />
                <h4 className='mt-5'> "The system is automated, user-friendly and it is also easy to be monitored, 
                ...
                alt='Franchisee Pic' 
                className='mt-5' />
                <h4 className='fw-bold mt-3'>Paolo S. Bobier</h4>
                <h7 >Franchise Owner, One SM Lending Corporation</h7>
            </Col>
        </Row>
    </Container>
  )
